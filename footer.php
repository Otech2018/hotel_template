...
href="<?=$site_link; ?>/index.php#section-contact" title="Contact us" target=_self>Contact us</a></li><li><a
href="<?=$site_link; ?>/kuala-lumpur-luxury-hotel-information/privacy-policy-and-copyright/" title="">Privacy Act &amp; Copyright</a></li></ul><div
class="urc"><div
class="f-logo">
<a
...
class="copyright">&copy; 2020&nbsp;The <?=$site_name; ?>Hotel and Residences. All rights reserved.</span></p></div>
</a></td>
</a></td>
</a>
</a></div><div
...
<input
name="thankyou_msg" value="<p>Your subscription for our newsletter has been submitted successfully.</p><p>Thank you for your interest in The <?=$site_name; ?>Hotel and Residences.</p>" type="hidden">
<input
...
<input
type="button" class="form-control ctc" value="Subscribe" id="footer_subscribe_btn" data-report-group="Subscribe Newsletter" data-report-label="Homepage" /><div
style="display:none;">
<span
...
</button><p>Your subscription for our newsletter has been submitted successfully.</p><p>Thank you for your interest in The <?=$site_name; ?>Hotel and Residences.</p></div></div></div></div></div><div
class="col-lg-3 footer-addr">
<address>
The <?=$site_name; ?>Hotel and Residences<br>
...
class="copyright"> &copy; <?=date('Y'); ?>&nbsp;The <?=$site_name; ?>Hotel and Residences. All rights reserved.</span></p></div></div></div></div></footer> 
